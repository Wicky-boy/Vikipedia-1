...
import parthiPFP from "../image/parthi.png";
import DharaniPFP from "../image/Dharani.png";
...
function LandingPage() {
  ...
  function onSubmitEventHandler(event) {
    ...
    axios
      .post("/opinion", { opinion: userOpinion })
      .then((response) => {
        console.log("Done");
      })
      .catch((err) => {
      ...
      <section className="firstViewPage">
        <Container className="homepageContainer">
          <Row xs={1} md={2}>
            <Col>
              <div>
                <h1 className="heading homepageHeading">Quizzify</h1>
                <h2 className="subHeading">This new slam site</h2>
                <p className="para">
                  Hey yo, This is new project which deals with Ultra popular
                  React Framework , Express which is one of the Node.js's
                  popular Framework and MongoDB which allows you to store upto
                  512MB in cloud for free of costs{" "}
                </p>
                <Link to="/register">
                  <Button
              ...
              <Col>
                <div className="card1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href="https://www.instagram.com/im_parthiban_raj/"
                  >
                    <button className="btn cardButton" as="input" type="button">
              ...
              <Col>
                <div className="card1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href="https://www.instagram.com/dharaniindira_/?igshid=1gjttfqxkec04"
                  >
                    <button className="btn cardButton" as="input" type="button">
                      <i class="fab fa-instagram"></i> Follow
                    </button>
            ...
            <Row xs={1} md={2}>
              ...
              <Col>
                <div className="opinionText">
                  ...
                  <p className="para">
                    If you like to help us to improve ,then feel free to share
                    your opinion below <br /> [e.g: yourname : your opinion ]
                  </p>
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={onSubmitEventHandler} autocomplete="off">
                      <TextField
                        ...
                        id="outlined-basic"
                        className="opinionInputBox"
                        label="Share your thoughts"
                        variant="outlined"
                      />
                      <Button className="OpinionButton" type="submit">
                        Submit
                      </Button>
                    </form>
                  )}
