...
function Home(match) {
  ...
  function getDetails() {
    axios.post("/home", { id: ID }).then((response) => {
            ...
            <Row xs={1} md={2}>
              <Col>
                <div className="customPadding">
                  ...
                  <p className="para">
                    Now you can create new slam and share them with your firends
                    and you could able to see their score in the table
                  </p>
                  ...
                  <div className="tablesDiv">
                    ...
                    {userAnswers.length > 0 ? (
                          ...
                          return (
                            <div className="homeResponseItemDiv" key={index}>
                              ...
                              <div className="homeResponseViewDiv">
                                <h3 className="homeResponseViewText">
                                  <Link
                                    to={`/view/${item.name}/${ID}/${index}`}
                                  >
                                    <Button className="homeResponseViewButton">
                                      View
                                    </Button>
                                  </Link>
                                </h3>
                      ...
                      <div>
                        ...
                        <p className="para">
                          Tips : Create new slam ,Share them with your friends
                          and then come back!
                        </p>
                      </div>
                    )}
