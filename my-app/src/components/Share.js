...
function Share(match){
    ...
    const path="http://localhost:3000/#/home/"+userID+"/"+indexNumber+"/response"
    ...
    return(
            ...
            <Row xs={1} md={2}>
                ...
                <input type="text" className="copyTextInput" id="copyText" name="country" value={`http://localhost:3000/#/home/${userID}/${indexNumber}/response`} readonly></input>
                </div>
                <div >
